...
| 題 | 問題 | 結果 | 差距是否大於隨機誤差 |
|---|---|---|---|
| E1 | 原始合成資料有多少被丟掉 | 300 次抽樣通過 48.3% | 否：二元與多元分類只差 4.7 個百分點 |
| E2 | 打亂標籤後閘門擋不擋得住 | 原樣 60/60 放行，打亂後 0/60 誤放行 | 是：閘門分得出有結構與純雜訊 |
| E3 | 列數少時真的結構會不會被判成學不到 | 50 列 22.7%、150 列 32.0%、300 列 48.7%、1000 列 51.3% | 50 到 300 是；300 到 1000 否 |
| E4 | 高基數類別欄是否較難通過 | 數值 42.0%、200 類 32.7% | 否：差距約 1.6 個標準誤，未達 2 倍 |
